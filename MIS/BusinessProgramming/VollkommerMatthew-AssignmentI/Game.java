...
/**
 * This Class (when you complete the assignment) will extend Game, 
 * to hold unique information about a Game.  
 * 
 * 
 * @author Dale Goodhue
 * @version Game0
...
public class Game extends Item
{
    ...
    public Game(int thisKey, String thisName, String thisPlatform, double thisPrice, int renter, int thisDueDate){
        key = thisKey;
        name = thisName;
        renterID = renter;
        dueDate = thisDueDate;
    ...
    public void print()
    {
        ...
        // for renterID and dueDate is the same, whether the Game is rented 
    ...
    /**
     * .chargeOut. To charge (check) out a Game object.
     */
    ...
    /**
     * .getName. returns the name of this Game item.
     * 
     * @param  void   
     * @return  Name  
     */
    public String getName()
    {
     ...
     /**
     * .getKey. returns the key of this Game item.
     * 
     * @param  void   
     * @return  Key  
     */
    public int getKey()
    {
     ...
     /**
     * .getRenterID. returns the renterID of this Game item.
     * 
     * @param  void   
     * @return  renterID  
     */
    public int getRenterID()
    {
        return renterID;
         ...
         /**
     * .getDueDate. returns the renterID of this Game item.
     * 
     * @param  void   
     * @return  dueDate  
     */
